...
public abstract class SQLVarcharBase extends AbstractSQLValue {
	...
	public static int LENGTH = 2*SQLIntegerBase.LENGTH; //fixed length. 1 Int for size & 1 Int for pointer
	...
	public boolean equals(Object obj) {
		...
		return this.value.equals(cmp.value); // ignoring the length turned out to be more practical in most cases
	}
