...
public class SQLRowIdentifier extends AbstractSQLValue {
	...
	public int compareTo(AbstractSQLValue o) {
		...
		if(cmp.page.compareTo(this.page)>0)
			return 1;
		else if(cmp.page.compareTo(this.page)<0)
			return -1;
		
		if(cmp.slot.compareTo(this.slot)>0)
			return 1;
		else if(cmp.slot.compareTo(this.slot)<0)
			return -1;
	...
	public boolean equals(Object o){
		SQLRowIdentifier cmp = (SQLRowIdentifier)o;
		if(this.page==cmp.page && this.slot==cmp.slot)
			return true;
