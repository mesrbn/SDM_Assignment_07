...
public abstract class AbstractPage {
	 ...
	 * @param slotNumber
	 * @param record
	 * @param doShift if true: shift fixed length data to fit in the record in the specified slotNumber.
	 *                if false: overwrite the slot with new record, note: shifting any old variable length data is not required
	 */
